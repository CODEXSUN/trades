  ...
  for (const role of [
    {
      ...
      description: "Full Trades client administration access.",
      protected: true
    },
    {
      key: "manager",
      label: "Manager",
      description: "Operational management access without Application administration.",
      protected: true
    },
    {
      key: "staff",
      label: "Staff",
      description: "Standard operational access without Application administration.",
      protected: true
    },
    {
      key: "user",
