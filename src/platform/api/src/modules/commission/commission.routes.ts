...
export async function registerCommissionRoutes(app: FastifyInstance) {
  registerContractRoute(app, {
    ...
    handler: ({ query, request }) =>
      new CommissionService(tenantAccessContext(request)).listDeposits({
  ...
  registerContractRoute(app, {
    ...
    schemas: { querystring: querySchema, response: listSchema },
    handler: ({ query, request }) =>
      new CommissionService(tenantAccessContext(request)).listWithdrawals({
        ...(query.dateFrom ? { dateFrom: query.dateFrom } : {}),
        ...(query.dateTo ? { dateTo: query.dateTo } : {})
      })
  });
  registerContractRoute(app, {
    ...
    handler: ({ request }) => new CommissionService(tenantAccessContext(request)).variants()
  });
  registerContractRoute(app, {
    method: "PUT",
    ...
    handler: ({ body, params, request }) =>
      new CommissionService(tenantAccessContext(request)).updateVariant(params.id, body)
  });
  registerContractRoute(app, {
    method: "POST",
    ...
    handler: ({ params, request }) =>
      new CommissionService(tenantAccessContext(request)).settleDeposit(params.id)
  });
  registerContractRoute(app, {
    method: "POST",
    ...
    schemas: { params: idSchema, response: entrySchema },
    handler: ({ params, request }) =>
      new CommissionService(tenantAccessContext(request)).settleWithdrawal(params.id)
  });
}
