...
export async function registerBankAccountRoutes(app: FastifyInstance) {
  registerContractRoute(app, {
    ...
    handler: ({ query, request }) =>
      new BankAccountService(tenantAccessContext(request)).list(query.search ?? "")
  });
  registerContractRoute(app, {
    method: "GET",
    url: `${BANK_ACCOUNT_COLLECTION_PATH}/lookups`,
    schemas: { response: z.array(lookupSchema) },
    handler: ({ request }) => new BankAccountService(tenantAccessContext(request)).lookups()
  });
  registerContractRoute(app, {
    method: "POST",
    url: BANK_ACCOUNT_COLLECTION_PATH,
    ...
    handler: ({ body, request }) =>
      new BankAccountService(tenantAccessContext(request)).create(body)
  });
  registerContractRoute(app, {
    method: "POST",
    ...
    handler: ({ body, request }) =>
      new BankAccountService(tenantAccessContext(request)).transfer(body)
  });
  registerContractRoute(app, {
    method: "GET",
    ...
    handler: ({ params, request }) =>
      new BankAccountService(tenantAccessContext(request)).get(params.id)
  });
  registerContractRoute(app, {
    method: "PUT",
    url: `${BANK_ACCOUNT_COLLECTION_PATH}/:id`,
    ...
    handler: ({ body, params, request }) =>
      new BankAccountService(tenantAccessContext(request)).update(params.id, body)
  });
  registerContractRoute(app, {
    method: "GET",
    ...
    handler: ({ params, request }) =>
      new BankAccountService(tenantAccessContext(request)).statement(params.id)
  });
  registerContractRoute(app, {
    method: "POST",
    ...
    handler: ({ body, params, request }) =>
      new BankAccountService(tenantAccessContext(request)).createManualEntry(params.id, body)
  });
  for (const [action, status] of [
    ...
    registerContractRoute(app, {
      ...
      schemas: { params: idSchema, response: accountSchema },
      handler: ({ params, request }) =>
        new BankAccountService(tenantAccessContext(request)).setStatus(params.id, status)
    });
  for (const [action, reconciled] of [
    ...
    registerContractRoute(app, {
      ...
      handler: ({ params, request }) =>
        new BankAccountService(tenantAccessContext(request)).setReconciled(
          params.entryId,
          reconciled
        )
    });
  registerContractRoute(app, {
    ...
    schemas: { params: idSchema, response: accountSchema },
    handler: ({ params, request }) =>
      new BankAccountService(tenantAccessContext(request)).forceDelete(params.id)
  });
}
