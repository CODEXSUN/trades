  ...
  async updateAccess(
    ...
    const normalizedKeys = Array.from(
      ...
      .filter(
        (key) =>
          ...
          key !== "crm" &&
          key !== "frappe" &&
          (defaultTenantModuleKeys.some((defaultKey) => defaultKey === key) ||
            !manuallyDisabledKeys.includes(key))
      )
      .sort();
    const payloadSettings = {
      ...
      apps: {
        ...
        disabled: manuallyDisabledKeys.filter(
