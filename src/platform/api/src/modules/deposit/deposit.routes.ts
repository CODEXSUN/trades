...
export async function registerDepositRoutes(app: FastifyInstance) {
  registerContractRoute(app, {
    handler: ({ query, request }) =>
      new DepositService(tenantAccessContext(request)).list(
  ...
  registerContractRoute(app, {
    handler: async ({ params, request }) => {
      const record = await new DepositService(tenantAccessContext(request)).get(params.id);
  ...
  registerContractRoute(app, {
    handler: ({ body, request }) => new DepositService(tenantAccessContext(request)).create(body),
    method: "POST",
  ...
  registerContractRoute(app, {
    handler: ({ body, params, request }) =>
      new DepositService(tenantAccessContext(request)).update(params.id, body),
    method: "PUT",
    schemas: {
  ...
  registerContractRoute(app, {
    handler: ({ params, request }) =>
      new DepositService(tenantAccessContext(request)).forceDelete(params.id),
    method: "DELETE",
    schemas: { params: idParamsSchema, response: depositSchema },
...
function registerStatusRoute(
  ...
  registerContractRoute(app, {
    handler: ({ params, request }) =>
      new DepositService(tenantAccessContext(request)).setStatus(params.id, status),
    method: "POST",
    schemas: { params: idParamsSchema, response: depositSchema },
